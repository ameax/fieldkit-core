# This is my package fieldkit-core
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/fieldkit-core.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/fieldkit-core)
...
```bash
php artisan vendor:publish --tag="fieldkit-core-views"
```

## Usage

```php
$fieldkitCore = new Ameax\FieldkitCore();
echo $fieldkitCore->echoPhrase('Hello, Ameax!');
```
